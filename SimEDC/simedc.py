...
if __name__ == "__main__":
    ...
    print("\n*********** Configuration ***********")
    print("total_iterations = %d\nnum_processes = %d\nmission_time(hours) = %d" % (total_iterations, num_processes, mission_time))
    print("rseed_plus = %d" % rseed_plus)
    print("num_racks = %d\nnodes_per_rack = %d\ndisks_per_node = %d\ncapacity_per_disk = %d" % (num_racks, nodes_per_rack, disks_per_node, capacity_per_disk))
    ...
    jobs = list(zip(iterations_per_job, enumerates))
